...
public class QualificationController {
  ...
  private void initialize() {
            ...
            (obs, oldValue, newValue) -> {
              if (newValue == null) {
                ...
                labelSelection.setText(
                    String.format(
                        "Séquence %s - %.1f kHz",
                        newValue.getHorodatage(), newValue.getFrequenceDominanteKHz()));
              }
              labelLecture.setText("");
            });
    ...
    // (binding
    // bidirectionnel).
    Bindings.bindBidirectional(zoneCommentaire.textProperty(), nuit.commentaireProperty());
  }
  ...
  private void ecouter() {
    ...
    pauseTransition.setOnFinished(e -> labelLecture.setText(""));
